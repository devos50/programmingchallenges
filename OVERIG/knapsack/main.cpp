...
int n = 2; /* The number of objects */
int c[10] = {99, 109}; /* c[i] is the *COST* of the ith object; i.e. what
                YOU PAY to take the object */
int v[10] = {100, 105}; /* v[i] is the *VALUE* of the ith object; i.e.
                what YOU GET for taking the object */
int W = 1000; /* The maximum weight you can take */
